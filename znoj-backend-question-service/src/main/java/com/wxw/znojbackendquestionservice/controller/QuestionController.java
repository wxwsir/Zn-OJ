package com.wxw.znojbackendquestionservice.controller;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.gson.Gson;
import com.wxw.znojbackendcommon.annotation.AuthCheck;
import com.wxw.znojbackendcommon.common.BaseResponse;
import com.wxw.znojbackendcommon.common.DeleteRequest;
import com.wxw.znojbackendcommon.common.ErrorCode;
import com.wxw.znojbackendcommon.common.ResultUtils;
import com.wxw.znojbackendcommon.constant.UserConstant;
import com.wxw.znojbackendcommon.exception.BusinessException;
import com.wxw.znojbackendcommon.exception.ThrowUtils;
import com.wxw.znojbackendmodel.model.dto.question.*;
...
import com.wxw.znojbackendquestionservice.config.RedisLimiterManager;
...
public class QuestionController {
    ...
    public BaseResponse<Boolean> deleteQuestion(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 判断用户是否为题目作者/管理员
        if(!user.getId().equals(question.getUserId()) && userFeignClient.isAdmin(user)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
        boolean remove = questionService.removeById(questionId);
        if(!remove) {
